...
class ExportWindow(QMainWindow):
    def __init__(self, preferences=None):
        ...
        self.color_confirm = QCheckBox("SDR Rec.709, flattened source")
        self.color_confirm.setToolTip("Confirm that the PNGs were exported in SDR Rec.709. ICC profiles are not converted. No noise or dither is added. Output is 8-bit YUV 4:2:0, VP9 Profile 0, without audio.")
